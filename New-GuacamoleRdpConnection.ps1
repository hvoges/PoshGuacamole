Function New-GuacamoleRdpConnection {
    ...
    Process {
        ...
        # Create Empty Hashtable for Parameters and Attributes
        ...
        Try {
            $WebResponse = Invoke-WebRequest -Uri $EndPoint -Method Post -ContentType 'application/json' -Body $RequestBody
        }
        Catch {
            Throw $_
        }
