...
<#
.SYNOPSIS
    Removes User-Permissions from a Connection
.DESCRIPTION
    This Cmdlet removes Read-Permissions from a User for a Connection. You can remove users from connections or connections from users. 
.EXAMPLE
    PS C:\> Remove-GuacamoleUserConnection -Username DemoUser -ConnectionID 43
